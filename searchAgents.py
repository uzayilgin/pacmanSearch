...
class CornersProblem(search.SearchProblem):
    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if hitsWall == False:
                if ((successorState in self.corners) and (successorState not in state[1])):
                    successors += [((successorState, (state[1] + [successorState])), action, 1)]
                else:
                    successors += [((successorState, (state[1])), action, 1)]
    ...
    while len(unvisitedCorners)!=0:
        ...
        for corner in unvisitedCorners:
            ...
            if minDistance > distance:
                ...
                removedCorner = corner
        totalCost += minDistance
        current = removedCorner
        unvisitedCorners.remove(removedCorner)
    return totalCost
    util.raiseNotDefined()
